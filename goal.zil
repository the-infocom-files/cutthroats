...
<ROUTINE FOLLOW-GOAL (PERSON "AUX" (HERE <LOC .PERSON>) LINE RM GT GOAL FLG
		      		   (GOAL-FLAG <>) (IGOAL <>) LOC (CNT 1))
	 #DECL ((PERSON HERE LOC RM) OBJECT (CNT) FIX
...
<ROUTINE ESTABLISH-GOAL (PERSON GOAL "OPTIONAL" (PRIORITY <>)
			 	     "AUX" (HERE <LOC .PERSON>) GT)
	 #DECL ((PERSON GOAL HERE) OBJECT
...
<ROUTINE DIR-FROM (HERE THERE "AUX" (V <>) (P 0) L Z)
